...
namespace PlantHunter.Mobile.Core
{
	public static class AppSettings
    {
        ...
        static string defaultPlantsEndpoint;
        ...
        public const string DefaultFallbackMapsLocation = "21.423578,-157.933744";
        ...
        {           
            ...
            defaultPlantsEndpoint = "https://planthunter-2-dev-as.azurewebsites.net/";
        }
        ...
        // API Endpoints
        public static string PlantsEndpoint
        {
            get => Preferences.Get(nameof(PlantsEndpoint), defaultPlantsEndpoint);
            set => Preferences.Set(nameof(PlantsEndpoint), value);
        }
